...
const GoogleSheetInput = function () {
    ...
    self.build = function () {
        ...
        if (queryParams.sheetId) {
            ...
            var bannerText = '<h1>Build your own radar</h1><p>Once you\'ve Created your Radar, you can use this service' +
...
function plotLogo(content) {
    content.append('div')
        ...
        .html('<a href="https://content.pivotal.io"><img src="/images/pivotal-logo.png" / ></a>');
}
...
function plotFooter(content) {
    content
        ...
        .append('p')
        .html('@2017, Pivotal Software, Inc. All Rights Reserved, Confidential');
